...
<head>
  ...
  <!-- rtl css -->
  <link href="css/rtl.css" class="rtlcss " rel="stylesheet" type="text/css">

  <!-- For demousers scripts and styles -->
</head>

<body class="slides scroll noPreload animated">
  <div id="loadingMask" style="width: 100%; height: 100%;z-index: 10000;
  color: black; position: fixed; background: #fff;     display: flex;
    justify-content: center;"><p style="    align-self: center;" >Loading...</p></div>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display:none">
    ...
    <symbol id="play_arrow" viewBox="0 0 30 30">
  ...
  <!-- Panel Top #library/panel/panel-top-03.html -->
  <nav class="panel top white">
    <div class="sections desktop">
      ...
      <div class="center">
        <ul class="menu">
          <li><a href="#lorem1"data-localize="lorem1">lorem1</a></li>
          <li><a href="#lorem2"data-localize="lorem2">lorem2</a></li>
          <li><a href="#"data-localize="lorem3">lorem3</a></li>
          <li><a href="#"data-localize="lorem4">lorem4</a></li>
          <li>
            <span class="lang-btn en" role='button'>EN</span>
            <span class="lang-btn ar hidden" role='button'>عربى</span>
          </li>
          <li>
            <a href="http://facebook.com/designmodo" class="facebook" target="_blank">
              <svg >
      ...
      <div class="right"><a class="button red red-sdw " href="#" data-localize="Profile">Profile</a></div>
    </div>
    <div class="sections compact hidden" >
      <div class="left"><a href="#" title="Slides Framework"><svg style="width:82px;height:24px">
            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#logo"></use>
          </svg></a></div>
      <div class="right"><span class="button red stroke  actionButton sidebarTrigger" data-sidebar-id="1"><svg>
  ...
  <!-- Sidebar -->
  <nav class="sidebar white right" data-sidebar-id="1">
    <div class="close"><svg>
        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#close"></use>
      </svg></div>
    <div class="content">
      <ul class="mainMenu margin-top-3">
      <li><a href="#"data-localize="lorem1">lorem1</a></li>
          <li><a href="#"data-localize="lorem2">lorem2</a></li>
          <li><a href="#"data-localize="lorem3">lorem3</a></li>
          <li><a href="#"data-localize="lorem4">lorem4</a></li>
          <li>
            <span class="lang-btn en" role='button'>EN</span>
  ...
  <!-- Slide 1 (#08) -->
  <section class="slide overlay white" data-name="lorem1" >
    <div class="content">
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-12-12">
            ...
            <p class="hero fix-9-12 margin-top-2 ae-2"><span class="opacity-8" data-localize="header">Perfection is achieved, not when there
                is nothing more to add, but when there is nothing left to take&nbsp;away.</span></p>
            <div class="margin-top-2">
              <p class="ae-3"><span class="opacity-8" data-localize="subHeader">Start now and get <b>free bonus</b> on account</span></p>
              <form class="slides-form" action="#">
                <input type="email" class="input-8 ae-4 fromCenter" name="user-email" placeholder="Email" val="" />
                <input type="password" class="input-8 ae-5 fromCenter" name="user-password" placeholder="Password" val="" />
                <input type="password" class="input-8 ae-6 fromCenter" name="confirm-password" placeholder="Confirm the password"
                  val="" />
                <button type="submit" class="button red red-sdw    ae-7 fromCenter" name="button"data-localize="GetStarted">Get Started</button>
              </form>
            </div>
          </div>
  ...
  <!-- Slide 2 (#07) -->
  <section class="slide background" data-name="lorem2" style="background:rgb(253, 59, 45);">
    <div class="content">
      <div class="container">
        <div class="wrap">

          <div class="fix-11-12">
            <h1 class="cropBottom ae-1 fromCenter">
            <p data-localize="text1">Slides Framework</p>
              <span class="button play small red red-sdw popupTrigger button-7" data-popup-id="7">
                <svg>
                  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#play_arrow"></use>
                </svg>
              </span>
              <p data-localize="text2"> Built to impress </p>
            </h1>
          </div>
        ...
        <div class="wrap">
          <div class="fix-10-12">
            <div class="embedVideo popupContent">
              <iframe src="https://www.youtube.com/embed/g8yBqxTiHSs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
      ...
      <div class="container">
        <div class="wrap">
          ...
          <ul class="grid">
            <li class="col-12-12">
              <div class="fix-4-12">
                <svg class="ae-1 fix-3-12 margin-bottom-6" style="height: 76px;">
                  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#logo"></use>
                </svg>
                <a href="#" class="button hollow ae-2 cropLeft appstoreImg"><img src="assets/img/appstore.jpg" height="63" /></a><a
                  href="#" class="button hollow ae-3 cropRight"><img src="assets/img/googleplay.jpg" height="63" /></a>
              </div>
            </li>
            <li class="col-12-12">
              <div class="fix-6-12 ae-2 margin-top-3">
                <img width="480" src="assets/img/iphone-5.png" class="shiftImage iphone-5" alt="iPhone App" data-action="zoom" />
              </div>
            </li>
          </ul>
  ...
  <section class="slide whiteSlide">
    <div class="content">
      <div class="container">
        <div class="wrap">
          <div class="fix-9-12">
            <h1 class="ae-1" data-localize="slide5Text1">One of the tragedies of the design scene is that it always acts too late</h1>
            <p class="ae-2"><span class="opacity-8" data-localize="slide5Text12">He takes snapshots, makes notes and records impressions on
                tablecloths or newspapers, on backs of envelopes or matchbooks. Why one thing and not another is part
                of the mystery, but he is&nbsp;omnivorous.</span></p>
            <a class="button red red-sdw  ae-5 fromCenter" data-localize="GetStarted">Get Started</a>
          </div>
  ...
  <nav class="panel bottom   forceMobileView">
    <div class="sections desktop">
      <div class="left"><span class="opacity-8">Build with <a href="#" title="Slides Framework"><svg style="width:52px;height:21px">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#logo"></use>
            </svg></a></span></div>
      <div class="center"><span class="opacity-8 semiBold">No risk trial • Support • Frequent updates</span></div>
      <div class="right"><span data-dropdown-id="2" class="button actionButton dropdownTrigger">
        <!-- <svg>
    ...
    <div class="sections compact hidden">
      <div class="left">Build with <a href="#" title="Slides Framework"><svg style="width:58px;height:16px">
            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#logo"></use>
          </svg></a></div>
      <div class="right"><span data-dropdown-id="2" class="button actionButton dropdownTrigger">
        <!-- <svg>
  ...
  <!-- Share Window -->
  <div class="dropdown share bottom right" data-dropdown-id="2" data-text="Take a look at this" data-url="https://designmodo.com"
    ...
    <script src="js/jquery.localize.min.js" type="text/javascript"></script>
